...
def espionar_requisicao(request, api_info):
    """Listener que espiona requisições para capturar a URL
    da API de login e o formato do JSON"""
...
def find_login_api_url(target_url):
    ...
    captura o URL da API e o formato do JSON usado. Retorna um
    dicionário com 'url' e 'json_format'.
    """
