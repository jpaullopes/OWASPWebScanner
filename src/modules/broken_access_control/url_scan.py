...
def word_list_reader(word_list):
    """Responsavél por fazer a leitura do arquivo de wordlist e
    retornar uma lista de URLs."""
    url_list = []
    try:
...
def url_scanner(login_url, base_url, word_list):
    ...
    with sync_playwright() as p:
        ...
        login_success = login_acess(page, login_url)
...
url_scanner(target_login_url, target_base_url, wordlist_path)
